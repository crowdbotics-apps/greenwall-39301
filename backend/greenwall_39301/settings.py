"""
Django settings for greenwall_39301 project.
...
ROOT_URLCONF = 'greenwall_39301.urls'
...
WSGI_APPLICATION = 'greenwall_39301.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "greenwall_39301 API",
    "DESCRIPTION": "API documentation for greenwall_39301 App",
    "VERSION": "v1",
}
